...
public class Jdbc01 {
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        //加载类`com.mysql.jdbc.Driver'。 这已被弃用。 新的驱动程序类是`com.mysql.cj.jdbc.Driver'。 驱动通过SPI自动注册，一般不需要手动加载驱动类
        ...
        String sql = "Insert into actor values(NULL,'小龙女','女','2002-04-24','114')";
