...
public class API_ {
    public static void main(String[] args) throws UnknownHostException {
        ...
        System.out.println(localHost);//LAPTOP-1VBBRV6U/192.168.231.1

        //2. 根据指定主机名 获取 InetAddress对象
        InetAddress host1 = InetAddress.getByName("LAPTOP-1VBBRV6U");
        System.out.println("host1=" + host1);//LAPTOP-1VBBRV6U/192.168.231.1
